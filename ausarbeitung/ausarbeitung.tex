...
% TODO: Wir sollten zumindest Erwähnen, dass wir Python/Numpy/Scipy/Keras nutzen!
...
Der zugehörige Train/Validation-Split beim diesem Ansatz war 8:2. % TODO: Dieses Detail vielleicht woanders hin?
...
Die Wahl fiel dabei auf \emph{Xception}. % TODO: Referenz?
...
% TODO: Diese section sollte bei den Experimenten stehen!? Hat ja schließlich nach Experimentieren nicht ganz so gut funktioniert :P
