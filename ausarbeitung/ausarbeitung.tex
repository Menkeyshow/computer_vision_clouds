...
Im 19. Jahrhundert begannen Wissenschaftler damit, Wolken zu typisieren, und schufen damit die Grundlage der heutigen Forschung. % TODO: Quelle?, %gehört zur quelle vom zitat, soll das doppelt gekennzeichnet werden
...
% TODO: Hier stand mal was mit Leave-One-Out Cross-Validation... ich habe es raus genommen, denn zumindest ich habe *null* Ahnung was das bedeuten soll... --Lukas - finde auch dass es nicht passt so früh schon so speziell zu werden - ali
...
%Entweder wir machen \newpage oder wir nehmen den Wikepedia satz raus, ich finde das passt auch nicht wirklich gut auf wikepedia zu verweisen, falls man mehr info will; das ist ja selbstverständlich-ali
...
%Bin ehrlich gesagt nicht sicher, was genau du damit meinst... Eine totale Wiederholung aus Kapitel 4 würde ich gerne vermeiden. Meinst du eine Art allgemeine Erklärung, wie genau die Standardmerkmale extrahiert werden?

%Standardmerkmale erwähnen
...
%Kantenzählung nochmal referenzieren? Eig haben wir das ja schon weiter oben getan UND es ist literally das nächste Kapitel --Max
...
%TODO: Ist der Anhang vom CloudGame als auch unser Quellcode nicht einfach am Ende dieses Dokuments? Wir geben doch am Ende nur eine pdf-Datei ab, oder irre ich mich? Dann sollte CloudGame.pdf so natürlich nicht stehen bleiben-- Max
...
%TODO: Sollte man hier noch reinschreiben, dass die Ergebnisse auch ganz anders sein hätten können bei der Studie? evtl in Richtung, man kann ja den Testies nicht zumuten, alle Bilder so wie die Maschine zuzuordnen? Oder dass bei einer anderen Auswahl der 36 Bilder das Ergebniss ganz anders aussehen könnte?
...
\includegraphics[height=\dimexpr\textheight-4\baselineskip\relax,page=1]{CloudGame.pdf}
%vvvvvv wollte die erste Seite eig größer haben, hat aber mit der Überschrift nicht geklappt
%\includepdf[pages=1,pagecommand={\thispagestyle{empty}\section{Cloud Game}}]{CloudGame}
\includepdf[pages=2-]{CloudGame.pdf}
