...
Die Wahl fiel dabei auf \emph{Xception} \cite{keras:xception}.
...
{\includegraphics[width=0.83\textwidth]{edge_count_boxplot.png}} \\
\subfigure[Swarmplot Kantenzählung]
{\includegraphics[width=0.83\textwidth]{edge_count_swarmplot.png}}
